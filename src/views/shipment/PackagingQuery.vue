<template>
  <div class="app_page_main">
    ...
    <div class="app_banner2 pc_app_banner2" v-if="app_banner1_tabs_key === 2">
      <!-- 辅料 -->
      <div class="fu_liao_body fu_liao_body_2">
        <div class="flb_ban1">
        ...
        <div class="flb_ban3">
          ...
          <table class="table_1">
            ...
            <tr
              @click="fu_look(1)"
              :class="dialog_look_type === 1?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">装配件</td>
              <td class="w_50">{{dataSource_fu.assemblyPartsNumbers}}</td>
            </tr>
            <tr
              @click="fu_look(2)"
              :class="dialog_look_type === 2?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">插件</td>
              <td class="w_50">{{dataSource_fu.plugInNumbers}}</td>
            </tr>
            <tr
              @click="fu_look(3)"
              :class="dialog_look_type === 3?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">钢套</td>
              <td class="w_50">{{dataSource_fu.steelSleeveNumbers}}</td>
            </tr>
            <tr
              @click="fu_look(4)"
              :class="dialog_look_type === 4?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">工装</td>
              <td class="w_50">{{dataSource_fu.workClothesNumbers}}</td>
            </tr>
            <tr
              @click="fu_look(5)"
              :class="dialog_look_type === 5?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">辅材</td>
              <td class="w_50">{{dataSource_fu.auxiliaryMaterialsNumbers}}</td>
            </tr>
            <tr
              @click="fu_look(6)"
              :class="dialog_look_type === 6?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">条码</td>
              <td class="w_50">{{dataSource_fu.barCodeNumbers}}</td>
            </tr>
            <tr
              @click="fu_look(7)"
              :class="dialog_look_type === 7?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">标签</td>
              <td class="w_50">{{dataSource_fu.tagNumbers}}</td>
            </tr>
            <tr
              @click="fu_look(8)"
              :class="dialog_look_type === 8?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">报告</td>
              <td class="w_50">{{dataSource_fu.reportNumbers}}</td>
            </tr>
            <tr
              @click="fu_look(9)"
              :class="dialog_look_type === 9?'choose_fu_msg choosetable':'choosetable'"
            >
              <td class="w_50">其他</td>
              <td class="w_50">{{dataSource_fu.otherNumbers}}</td>
            </tr>
          </table>
        </div>
      </div>
      <div class="fu_liao_body_3">
        <div>
    ...
    <div class="app_banner2" v-if="app_banner1_tabs_key === 1">
      <div>
        <div
          ...
          class="demo-infinite-container pc_zhucai_body"
          :infinite-scroll-disabled="t_busy"
          :infinite-scroll-distance="10"
        >
          <div
            class="app_ban2_list_item app_ban2_list_item_m0 fu_liao_body aban2_list_item_bb"
...
import listItem from '@/views/mobile/shipment/component/list_item'
...
.choose_fu_msg {
  background: rgb(245, 248, 250, 0.6);
}
.choosetable {
  cursor: pointer;
}
