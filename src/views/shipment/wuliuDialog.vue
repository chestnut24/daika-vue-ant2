  ...
  <div class="reviewTimeDialog">
    ...
    <div class="banner_ling" v-if="processOrder[2].length">
      <div v-for="(item,index) in processOrder[2]" :key="item.id">
        <ship-msg9 :matterData="item" :isShow="true" :bottomHaves="(index+1) === processOrder[2].length?true: false"></ship-msg9>
      </div>
    </div>
    ...
    <div class="banner_ling" v-if="processOrder[4].length">
      <div v-for="(item,index) in processOrder[4]" :key="item.id">
        <ship-msg9 :matterData="item" :isShow="false" :bottomHaves="(index+1) === processOrder[4].length?true: false">
          <template v-slot:btn>
            <a-switch
