<template>
  <div :class="['main', 'user-layout-register', device]">
<!--    <h3 class="mobile-row"><span>注册</span></h3>-->
    <a-form class="mobile-container" ref="formRegister" :autoFormCreate="(form)=>{this.form = form}" id="formRegister">
      <a-form-item
        class="mobile-row"
      ...
      <a-popover
        class="mobile-row"  placement="rightTop" trigger="click" :visible="state.passwordLevelChecked">
...
<!--      <a-row :gutter="device === 'desktop' ? 16 : 0" class="mobile-row">-->
      <a-row class="mobile-row">
        <a-col class="gutter-row" :md="16" :sm="24" :style="device === 'desktop' ? 'padding-right: 16px' : ''" >
          <a-form-item
        ...
        <a-col class="gutter-row" :md="8" :sm="24">
          <a-button
            class="getCaptcha"
            size="large"
      ...
      <a-form-item class="mobile-row mobile-btn">
        <a-button
          size="large"
          type="primary"
          htmlType="submit"
