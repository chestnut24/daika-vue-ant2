<template>
  <div>
    ...
    <table class="table_2">
      ...
      <tr style="background: #F5F8FA;">
        <th style="width: 25%;">复查总数</th>
        <th style="width: 25%;">合格数</th>
        <th style="width: 25%;">不合格数</th>
        <th style="width: 25%;">报废数量</th>
      </tr>
      <tr>
        ...
        <td v-else>
          <a-input-number
            ...
            size="small"
            :min="0"
            v-model="pageData.qualifiedNumber"
            @change="onChange"
          />
        </td>
        ...
        <td v-else>
          <a-input-number
            ...
            size="small"
            :min="0"
            v-model="pageData.notQualifiedNumber"
            @change="onChange"
          />
        </td>
        ...
        <td v-else>
          <a-input-number
            ...
            size="small"
            :min="0"
            v-model="pageData.scrapQualifiedNumber"
            @change="onChange"
          />
        </td>
      </tr>
    ...
    <div class="banner2_body">
      <div class="banner2 ban_content">
        <div class="b2_title">缺陷描述：</div>
        <div class="b2_input_msg" v-if="isShow">
          <div v-for="item in DefectCodes" :key="item.index" style="width: 100%;text-align: left;">
            <p v-if="defectDescriptionList.indexOf(item.index) !== -1">
              <a-tag color="blue" style="width: 38px;text-align: center;">{{item.index}}</a-tag>
              {{item.landd}}
            </p>
          </div>
        </div>
        <div class="b2_input" v-else>
          <a-select
      ...
      <div class="banner2 ban_content">
        <div class="b2_title">签批说明：</div>
        <div class="b2_input_msg" v-if="isShow">{{pageData.endorsementExplain}}</div>
        <div class="b2_input" v-else>
          <a-textarea
            class="b2_input_wuliu"
...
.b2_input /deep/ .ant-select-selection {
  background-color: #f5f8fa;
  border: 1px solid transparent;
  padding: 8px 13px;
  height: auto;
