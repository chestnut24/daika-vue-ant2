<template>
  <div class="all-frame" @scroll="scrollInformation">
    <div class="search-frame">
      ...
      <div class="goWaitingBord" @click="goManualReturnBord">
        <img src="../../../assets/sampleLibrary/goManualReturnBord.png" height="21" width="20"/>
      </div>
    </div>
    <div class="information-frame" v-for="(item,index) in dataSource" :key="index">
      <div class="information-item-top">
        ...
        <div class="item-top-right">
          ...
          <span style="font-size: 14px;color: #B0B0B0" @click="goReturnBordModal(item)"><a-icon type="right" /></span>
        </div>
      </div>
...
<script>
  import {getMouldOptions,getWarehousingReturnManagement} from '@api/api'
  export default {
    name: 'sampleReturnBord',
    mounted() {
      this.getDic();
      setTimeout(()=>{
        this.getList();
      ...
      goReturnBordModal(item){
        this.$router.push({
          ...
          query:{
            ...
            needReturnNum:item.needReturnNum,
