<template>
  <div class='page-wrap'>
    <div class='upload-file-wrap'>
      ...
      <a-upload
        name="file" :multiple="false" action=""  :before-upload="beforeUpload" :fileList='fileList'>
...
export default {
  ...
  methods:{
    ...
    uploadFile(){
      ...
      console.log("工艺参数文件",qualityFile)
