<template>
  <div style="overflow-x: auto">
    <div style="min-width: 1600px">
        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline" class="formSearch">
            ...
            <a-row :gutter="24">
              ...
              <a-col :span="6" style="float: right;margin-right: 12px">
                <a-form-item>
                  <a-button type="primary" @click="handelDHXGant" style="background:#ff4081;border-color:#ff4081">查看排产结果</a-button>
                  <a-button type="primary" @click="handelAdd" style="margin-left: 8px;background:#ff4081;border-color:#ff4081">新增占位计划</a-button>
                </a-form-item>
              </a-col>
            </a-row>
            </a-card>
            <a-card class="card1" style="margin-top: 12px">
              <a-row :gutter="24">
                <a-col :span="6">
                ...
                <template v-if="isShowOtherButtons">
                  <a-col :span="6">
                  ...
                  <a-col :span="11" >
                    <a-form-item label="排产时间" >
                        ...
                        ></a-range-picker>
                      <a-button  @click="setTime('day')" style="margin-left: 12px;border-radius: 0px">本日</a-button>
                      <a-button  @click="setTime('week')" style="border-radius: 0px;border-left: none;border-right: none">本周</a-button>
                      <a-button  @click="setTime('month')" style="border-radius: 0px">本月</a-button>
                    </a-form-item>
                  </a-col>
                </template>
                ...
                <a-col :span="7">
                  <a-form-item>
                    <a style="margin-right: 20px" :class="!isShowOtherButtons?'maxMargin':'minMargin'" @click="isShowOtherButtons = !isShowOtherButtons"> {{isShowOtherButtons?"收起":"展开"}} <a-icon :type="isShowOtherButtons?'up':'down'" /> </a>
        ...
        <!-- 操作按钮区域 -->
        <!-- table区域-begin -->
        <a-card class="schedul" style="margin-top: 12px">
        ...
        methods: {
                    ...
                    if(item.values.length){
                        item.values.forEach((itt,ind)=>{
                            ...
                            if(itt.onMachineTime){
                                ...
                                itt.machine=itt.productionMachine?itt.productionMachine:'';
            ...
            setTime(name) { // 快速确定时间，本日 本周 本月
                ...
                if (name === 'month') {
                    ...
                    this.queryParams.scheduleDtBegin=moment().format("YYYY-MM-DD 23:59:59")
                }
