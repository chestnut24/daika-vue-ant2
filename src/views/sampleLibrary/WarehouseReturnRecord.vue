...
<script>
  import {getMouldOptions,getWarehousingReturnRecord} from '@/api/api'
  export default {
    name: 'WarehouseReturnRecord',
    mounted() {
    ...
    data() {
      return{
        ...
        currentPage: 1, // 当前页
        columns: [
          { title: '回库时间', dataIndex: 'createTime', key: 'createTime', align: 'center', },
          ...
          { title: '回库数量', dataIndex: 'outWarehouse', key: 'outWarehouse', align: 'center', },
    ...
    methods: {
      ...
      getList(){
        ...
        getWarehousingReturnRecord(this.searchParams).then((data)=>{
          data = data.result;
