<template>
  <a-layout class="layout" :class="[device]">
    ...
    <a-layout
      ...
      <!-- layout content -->
      <a-layout-content
        :style="{ height: '100%', marginBottom: device === 'mobile' ? '50px' : '', paddingTop: fixedHeader ? '59px' : '0' }">
        <slot></slot>
      </a-layout-content>
...
<style lang="less">
  ...
  .ant-drawer.drawer-sider {
    ...
    &.dark {
      .ant-drawer-content {
        background-color: rgb(0, 21, 41); // 原颜色
        /*background-color: #192546; // 现在颜色*/
      }
    }
