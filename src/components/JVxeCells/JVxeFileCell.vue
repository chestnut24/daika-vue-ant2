...
<script>
  ...
  import JVxeCellMixins from '@comp/webeye/JVxeTable/mixins/JVxeCellMixins'
  import { ACCESS_TOKEN } from '@/store/mutation-types'
  import JFilePop from '@comp/webeye/minipop/JFilePop'

  import JVxeUploadCell from '@comp/webeye/JVxeTable/components/cells/JVxeUploadCell'
