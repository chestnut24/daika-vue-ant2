<template>
  <global-layout @dynamicRouterShow="dynamicRouterShow">
    ...
    <contextmenu :itemList="menuItemList" :visible.sync="menuVisible" style="z-index: 9999;color:#fff" @select="onMenuSelect"/>
    ...
    <div :style="device === 'desktop' ? 'margin: 16px 16px 0;' : ''">
