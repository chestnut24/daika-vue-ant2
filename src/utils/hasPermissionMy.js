  ...
  install(Vue, options) {
    ...
    Vue.directive('have', {
      inserted: (el, binding, vnode) => {
        console.log("页面权限控制----", el, binding, vnode);
        //console.time()
...
// valList 数组对象有两个属性，name value: 默认是true
export function isDisabled(valList) {

  let permissionList = [];  // 用户有的
  let allPermissionList = []; // 全部权限
